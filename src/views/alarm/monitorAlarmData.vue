	...
	<div>
		...
		<el-dialog title="新增信息"
			...
			<el-form ref="form" label-width="200px" :model="insertParam"  :rules="rules"  >
				...
				<el-form-item label="告警id唯一标识" style="width: 500px"  >
					<el-input v-model="insertParam.alarmId"   placeholder="请输入告警id唯一标识"></el-input>
				</el-form-item>
				<el-form-item label="告警类型" style="width: 500px"  >
					<el-input v-model="insertParam.alarmType"   placeholder="请输入告警类型"></el-input>
				</el-form-item>
				<el-form-item label="报警内容" style="width: 500px"  >
					<el-input v-model="insertParam.alarmContext"   placeholder="请输入报警内容"></el-input>
				</el-form-item>
				<el-form-item label="告警时间" style="width: 500px"  >
					<el-input v-model="insertParam.alarmTime" type="datetime-local"  placeholder="请输入告警时间"></el-input>
				</el-form-item>
			</el-form>
		...
		<el-dialog title="修改信息"
			...
			<el-form ref="form" label-width="200px">
				...
				<el-form-item label="告警时间" style="width: 500px" >
					<el-input v-model="editParam.alarmTime" type="datetime-local" placeholder="请输入告警时间"  ></el-input>
				</el-form-item>
			</el-form>
			<span slot="footer" class="dialog-footer">
