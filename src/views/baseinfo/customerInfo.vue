	...
	<div>
		...
		<el-dialog title="新增信息"
			...
			<el-form ref="form" label-width="200px" :model="insertParam"  :rules="rules"  >
				<el-form-item label="客户id" style="width: 500px" prop="customerId" >
					<el-input v-model="insertParam.customerId"   placeholder="请输入客户id"></el-input>
				</el-form-item>
				<el-form-item label="客户名称" style="width: 500px"  >
				...
				<el-form-item label="最后一次服务时间" style="width: 500px"  >
					<el-input v-model="insertParam.lastServicesTime" type="datetime-local"  placeholder="请输入最后一次服务时间"></el-input>
				</el-form-item>
				<el-form-item label="创建人" style="width: 500px"  >
					<el-input v-model="insertParam.creator"   placeholder="请输入创建人"></el-input>
				</el-form-item>
				<el-form-item label="创建时间/添加时间" style="width: 500px"  >
					<el-input v-model="insertParam.createTime" type="datetime-local"  placeholder="请输入创建时间/添加时间"></el-input>
				</el-form-item>
		...
		<el-dialog title="修改信息"
			...
			<el-form ref="form" label-width="200px">
				...
				<el-form-item label="最后一次服务时间" style="width: 500px" >
					<el-input v-model="editParam.lastServicesTime" type="datetime-local" placeholder="请输入最后一次服务时间"  ></el-input>
				</el-form-item>
				<el-form-item label="创建人" style="width: 500px" >
					<el-input v-model="editParam.creator"  placeholder="请输入创建人"  ></el-input>
				</el-form-item>
				<el-form-item label="创建时间/添加时间" style="width: 500px" >
					<el-input v-model="editParam.createTime" type="datetime-local" placeholder="请输入创建时间/添加时间"  ></el-input>
				</el-form-item>
				<el-form-item label="更新时间" style="width: 500px" >
