<template>
	<div>
		...
		<el-menu
			...
			<el-menu-item index="1">计划工单</el-menu-item>
		</el-menu>
		<br />
		...
		<el-dialog title="新增信息"
			...
			<el-form ref="form" label-width="200px" :model="insertParam"  :rules="rules"  >
				...
				<el-form-item label="计划完工日" style="width: 500px"  >
					<el-input v-model="insertParam.planCompletionDay" type="datetime-local"  placeholder="请输入计划完工日"></el-input>
				</el-form-item>
				<el-form-item label="接单时间" style="width: 500px"  >
					<el-input v-model="insertParam.receiveTime" type="datetime-local"  placeholder="请输入接单时间"></el-input>
				</el-form-item>
				<el-form-item label="开工时间" style="width: 500px"  >
					<el-input v-model="insertParam.startWorkTime" type="datetime-local"  placeholder="请输入开工时间"></el-input>
				</el-form-item>
				<el-form-item label="完工时间" style="width: 500px"  >
					<el-input v-model="insertParam.completionTime" type="datetime-local"  placeholder="请输入完工时间"></el-input>
				</el-form-item>
		...
		<el-dialog title="修改信息"
			...
			<el-form ref="form" label-width="200px">
				...
				<el-form-item label="计划完工日" style="width: 500px" >
					<el-input v-model="editParam.planCompletionDay" type="datetime-local" placeholder="请输入计划完工日"  ></el-input>
				</el-form-item>
				<el-form-item label="接单时间" style="width: 500px" >
					<el-input v-model="editParam.receiveTime" type="datetime-local" placeholder="请输入接单时间"  ></el-input>
				</el-form-item>
				<el-form-item label="开工时间" style="width: 500px" >
					<el-input v-model="editParam.startWorkTime" type="datetime-local" placeholder="请输入开工时间"  ></el-input>
				</el-form-item>
				<el-form-item label="完工时间" style="width: 500px" >
					<el-input v-model="editParam.completionTime" type="datetime-local" placeholder="请输入完工时间"  ></el-input>
				</el-form-item>
				<el-form-item label="工单创建时间" style="width: 500px" >
