<template>
	<div class="box-container">
		<el-tabs v-model="activeName" @tab-click="handleClick" style="padding: 0px 15px 0px 15px;background:#F3F3F3;font-weight: bold;">
			<el-tab-pane label="计划工单" name="first"></el-tab-pane>
		</el-tabs>
		...
		<el-table
			...
			<el-table-column :show-overflow-tooltip="true" :formatter="formatDate" prop="planCompletionDay" label="计划完工日">
				<template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    async handleOk () {
      ...
      planWorkorderInfoUpdate(this.okParam).then((response) => {
