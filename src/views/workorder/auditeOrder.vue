<template>
	<div>
		...
		<el-menu
			...
			<el-menu-item index="1">工单审核</el-menu-item>
		</el-menu>
		<br />
			...
			<el-col :span="22" class="grid">
				...
				<el-form ref="form" label-width="100px" >
					...
					<el-col :span="6" class="grid">
						<el-form-item label="工单编号" style="width: 300px"  >
							<el-input v-model="queryParam.orderId" placeholder="请输入工单编号"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="6" class="grid">
						<el-form-item label="站点责任部门" style="width: 300px"  >
							<el-input v-model="queryParam.responsiblerDepart" placeholder="请选择站点责任部门"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="6" class="grid">
						<el-form-item label="运维站点" style="width: 300px"  >
							<el-input v-model="queryParam.siteName" placeholder="请选择运维站点"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="6" class="grid">
						<el-form-item label="工单类型" style="width: 300px"  >
							<el-input v-model="queryParam.siteName" placeholder="请选择工单类型"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="6" class="grid">
						<el-form-item label="工单责任人" style="width: 300px"  >
							<el-input v-model="queryParam.responsiblerPerson" placeholder="请输入工单责任人"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="6" class="grid">
						<el-form-item label="创建时间" style="width: 300px"  >
							<el-input v-model="queryParam.createTime" placeholder="选择时间"></el-input>
						</el-form-item>
					</el-col>
				</el-form>
			</el-col>
			...
			<el-table-column label="操作" width="300" align="center">
				<template slot-scope="scope">
					<el-button	
							...
							icon="el-icon-edit"
							size="mini"
							@click="editData(scope.row)">详情</el-button>

					<el-button
							type="danger"
							icon="el-icon-delete"
							size="mini"
							@click="delData(scope.row)">同意</el-button>

					<el-button
							type="danger"
							icon="el-icon-delete"
							size="mini"
							@click="delData(scope.row)">驳回</el-button>
				</template>
			</el-table-column>
		</el-table>
		...
		<el-dialog title="新增信息"
			...
			<el-form ref="form" label-width="200px" :model="insertParam"  :rules="rules"  >
				<el-form-item label="工单编号" style="width: 500px" prop="orderId" >
				...
				<el-form-item label="计划完工日" style="width: 500px"  >
					<el-input v-model="insertParam.planCompletionDay" placeholder="请输入计划完工日"></el-input>
				</el-form-item>
				<el-form-item label="接单时间" style="width: 500px"  >
					<el-input v-model="insertParam.receiveTime" placeholder="请输入接单时间"></el-input>
				</el-form-item>
				<el-form-item label="开工时间" style="width: 500px"  >
					<el-input v-model="insertParam.startWorkTime" placeholder="请输入开工时间"></el-input>
				</el-form-item>
				<el-form-item label="完工时间" style="width: 500px"  >
				...
				<el-form-item label="工单创建人" style="width: 500px"  >
		...
		<el-dialog title="修改信息"
			...
			<el-form ref="form" label-width="200px">
				<el-form-item label="工单编号" style="width: 500px" >
				...
				<el-form-item label="计划完工日" style="width: 500px"  >
					<el-input v-model="editParam.planCompletionDay" placeholder="请输入计划完工日"></el-input>
				</el-form-item>
				<el-form-item label="接单时间" style="width: 500px"  >
					<el-input v-model="editParam.receiveTime" placeholder="请输入接单时间"></el-input>
				</el-form-item>
				<el-form-item label="开工时间" style="width: 500px"  >
					<el-input v-model="editParam.startWorkTime" placeholder="请输入开工时间"></el-input>
				</el-form-item>
				<el-form-item label="完工时间" style="width: 500px"  >
					<el-input v-model="editParam.completionTime" placeholder="请输入完工时间"></el-input>
				</el-form-item>
				<el-form-item label="工单创建时间" style="width: 500px"  >
					<el-input v-model="editParam.createTime" placeholder="请输入工单创建时间"></el-input>
				</el-form-item>
				<el-form-item label="工单创建人" style="width: 500px"  >
