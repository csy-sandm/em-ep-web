		...
		<el-dialog title="新增信息"
			...
			<el-form ref="form" label-width="150px" :model="insertParam"  :rules="rules"  >
				...
				<el-form-item label="报备时间" style="width: 50%;float: left;"  >
					<el-date-picker
						style="width: 100%;"
						v-model="insertParam.reportTime"
						type="datetime"
						placeholder="请输入报备时间">
					</el-date-picker>
				</el-form-item>
				...
				<el-form-item label="派单时间" style="width: 50%;float: left;"  >
					<el-date-picker
						style="width: 100%;"
						v-model="insertParam.dispatchTime"
						type="datetime"
						placeholder="请输入派单时间">
					</el-date-picker>
				</el-form-item>
				...
				<el-form-item label="工单创建人/派单人" style="width: 50%;float: left;"  >
		...
		<el-dialog title="修改信息"
			...
			<el-form ref="form" label-width="200px">
				...
				<el-form-item label="派单时间" style="width: 50%;float: left;" >
					<el-date-picker
						style="width: 100%;"
						v-model="editParam.dispatchTime"
						type="datetime"
						placeholder="请输入派单时间">
					</el-date-picker>
				</el-form-item>
