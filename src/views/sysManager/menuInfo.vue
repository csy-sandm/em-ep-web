<template>
	<div>
		...
		<el-menu
			...
			<el-menu-item index="1">系统菜单表</el-menu-item>
		</el-menu>
		<br />
		...
		<el-dialog title="新增信息"
			...
			<el-form ref="form" label-width="200px" >
				<el-form-item label="菜单ID" style="width: 500px" :required="rules.menuId" >
				...
				<el-form-item label="菜单地址" style="width: 500px"  >
				...
				<el-form-item label="菜单类型" style="width: 500px"  >
		...
		<el-dialog title="修改信息"
				   ...
				   :before-close="handleClose">
			<el-form ref="form" label-width="200px">
				<el-form-item label="菜单ID" style="width: 500px" >
