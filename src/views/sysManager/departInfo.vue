	...
	<div class="box-container">
		...
		<el-dialog title="新增信息"
			...
			<el-form ref="form" label-width="200px" :model="insertParam"  :rules="rules"  >
				<el-form-item label="部门ID" style="width: 50%;float: left;" prop="departId" >
					<el-input v-model="insertParam.departId" placeholder="请输入部门ID"></el-input>
				</el-form-item>
				<el-form-item label="部门名称" style="width: 50%;float: left;"  >
		...
		<el-dialog title="修改信息"
			...
			<el-form ref="form" label-width="200px">
				<el-form-item label="部门ID" style="width: 50%;float: left;" >
