<template>
	<div>
		...
		<el-menu
			...
			<el-menu-item index="1">部门信息</el-menu-item>
		</el-menu>
		<br />
			...
			<el-col :span="22" class="grid">
				...
				<el-form ref="form" label-width="100px" >
					...
					<el-col :span="6" class="grid">
						<el-form-item label="部门ID" style="width: 300px"  >
							<el-input v-model="queryParam.departId" placeholder="请输入部门ID"></el-input>
						</el-form-item>
					</el-col>
				</el-form>
			</el-col>
		...
		<el-dialog title="新增信息"
			...
			<el-form ref="form" label-width="200px" :model="insertParam"  :rules="rules"  >
				<el-form-item label="部门ID" style="width: 500px" prop="departId" >
					<el-input v-model="insertParam.departId" placeholder="请输入部门ID"></el-input>
				</el-form-item>
				<el-form-item label="部门名称" style="width: 500px"  >
					<el-input v-model="insertParam.departName" placeholder="请输入部门名称"></el-input>
				</el-form-item>
			</el-form>
		...
		<el-dialog title="修改信息"
			...
			<el-form ref="form" label-width="200px">
				<el-form-item label="部门ID" style="width: 500px" >
					<el-input v-model="editParam.departId" placeholder="请输入部门ID" :disabled="true" ></el-input>
				</el-form-item>
				<el-form-item label="部门名称" style="width: 500px"  >
					<el-input v-model="editParam.departName" placeholder="请输入部门名称"></el-input>
				</el-form-item>
			</el-form>
			<span slot="footer" class="dialog-footer">
	...
	export default {
		data() {
			return {
				...
				//必填字段 前面加'*'
				rules: {
					departId:[{ required: true, message: "请输入", trigger: "blur" }],
				}
		...
		methods: {
			...
			async exportExecl() {
				...
				departInfoQueryList(params).then((response) => {
					...
					outExportExcel(this.tableHeader, this.tableKey, this.tableData, "部门信息");
				});
			},
