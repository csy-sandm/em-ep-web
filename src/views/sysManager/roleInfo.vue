<template>
	<div>
		...
		<el-menu
			...
			<el-menu-item index="1">角色表</el-menu-item>
		</el-menu>
		<br />
		...
		<el-dialog title="新增信息"
			...
			<el-form ref="form" label-width="200px" >
				<el-form-item label="角色编码" style="width: 500px" :required="rules.roleCode" >
				...
				<el-form-item label="角色状态 0:启用 -1:冻结" style="width: 500px"  >
					<el-input v-model="insertParam.roleStatus" placeholder="请输入角色状态 0:启用 -1:冻结"></el-input>
				</el-form-item>
				<el-form-item label="备注信息" style="width: 500px"  >
					<el-input v-model="insertParam.roleRemark" placeholder="请输入备注信息"></el-input>
				</el-form-item>
				<el-form-item label="父级角色ID" style="width: 500px"  >
		...
		<el-dialog title="修改信息"
				   ...
				   :before-close="handleClose">
			<el-form ref="form" label-width="200px">
				<el-form-item label="角色编码" style="width: 500px" >
				...
				<el-form-item label="角色状态 0:启用 -1:冻结" style="width: 500px"  >
					<el-input v-model="editParam.roleStatus" placeholder="请输入角色状态 0:启用 -1:冻结"></el-input>
				</el-form-item>
				<el-form-item label="备注信息" style="width: 500px"  >
