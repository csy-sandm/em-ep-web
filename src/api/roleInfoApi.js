...
export function roleInfoQueryListByPage(params) {
	return myrequest({
		url: '/RoleInfoController/queryListByPage',
		method: 'post',
		data: params
	})
}
...
export function  roleInfoQueryList(params) {
	return myrequest({
		url: '/RoleInfoController/queryList',
		method: 'post',
		data: params
	})
}
...
export function  roleInfoInsertList(params) {
	return myrequest({
		url: '/RoleInfoController/insertList',
		method: 'post',
		data: params
	})
}
...
export function  roleInfoUpdateList(params) {
	return myrequest({
		url: '/RoleInfoController/updateList',
		method: 'post',
		data: params
	})
}
