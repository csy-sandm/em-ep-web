...
export function operateLogQueryListByPage(params) {
	return myrequest({
		url: '/v1/OperateLogController/queryListByPage',
		method: 'post',
		data: params
	})
}
...
export function  operateLogQueryList(params) {
	return myrequest({
		url: '/v1/OperateLogController/queryList',
		method: 'post',
		data: params
	})
}
...
export function  operateLogInsertList(params) {
	return myrequest({
		url: '/v1/OperateLogController/insertList',
		method: 'post',
		data: params
	})
}
...
export function  operateLogInsert(params) {
	return myrequest({
		url: '/v1/OperateLogController/insert',
		method: 'post',
		data: params
	})
}
...
export function  operateLogUpdateList(params) {
	return myrequest({
		url: '/v1/OperateLogController/updateList',
		method: 'post',
		data: params
	})
}
...
export function  operateLogUpdate(params) {
	return myrequest({
		url: '/v1/OperateLogController/update',
		method: 'post',
		data: params
	})
}
...
export function  operateLogDelete(params) {
	return myrequest({
		url: '/v1/OperateLogController/delete',
		method: 'post',
		data: params
	})
}