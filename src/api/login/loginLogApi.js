...
export function loginLogQueryListByPage(params) {
	return myrequest({
		url: '/v1/LoginLogController/queryListByPage',
		method: 'post',
		data: params
	})
}
...
export function  loginLogQueryList(params) {
	return myrequest({
		url: '/v1/LoginLogController/queryList',
		method: 'post',
		data: params
	})
}
...
export function  loginLogInsertList(params) {
	return myrequest({
		url: '/v1/LoginLogController/insertList',
		method: 'post',
		data: params
	})
}
...
export function  loginLogInsert(params) {
	return myrequest({
		url: '/v1/LoginLogController/insert',
		method: 'post',
		data: params
	})
}
...
export function  loginLogUpdateList(params) {
	return myrequest({
		url: '/v1/LoginLogController/updateList',
		method: 'post',
		data: params
	})
}
...
export function  loginLogUpdate(params) {
	return myrequest({
		url: '/v1/LoginLogController/update',
		method: 'post',
		data: params
	})
}
...
export function  loginLogDelete(params) {
	return myrequest({
		url: '/v1/LoginLogController/delete',
		method: 'post',
		data: params
	})
}