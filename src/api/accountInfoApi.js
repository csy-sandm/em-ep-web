...
export function accountInfoQueryListByPage (params) {
  return myrequest({
    url: '/AccountInfoController/queryListByPage',
    method: 'post',
    data: params
  })
}
...
export function accountInfoQueryList (params) {
  return myrequest({
    url: '/AccountInfoController/queryList',
    method: 'post',
    data: params
  })
}
...
export function accountInfoInsertList (params) {
  return myrequest({
    url: '/AccountInfoController/insertList',
    method: 'post',
    data: params
  })
}
...
export function accountInfoInsert (params) {
  return myrequest({
    url: '/AccountInfoController/insert',
    method: 'post',
    data: params
  })
}
...
export function accountInfoUpdateList (params) {
  return myrequest({
    url: '/AccountInfoController/updateList',
    method: 'post',
    data: params
  })
}
...
export function accountInfoUpdate (params) {
  return myrequest({
    url: '/AccountInfoController/update',
    method: 'post',
    data: params
  })
}
...
export function accountInfoDelete (params) {
  return myrequest({
    url: '/AccountInfoController/delete',
    method: 'post',
    data: params
  })
}
